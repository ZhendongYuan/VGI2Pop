...
library("Metrics")
library("densratio")
setwd("/home/z/********/london/enriched_feature/moa2loa_RF_CV/KLIEP")
...
weights = get(load("/home/z/********/london/enriched_feature/moa2loa_weights_KLIEP.Rdata"))
...
for (i in c(21:50))
{
  ...
  loa_transfer_predict = as.data.frame(h2o.predict(h2o.KLIEP, loa_transferred.h2o))
  ...
  save(singletime,file = paste(i,"_moa2loa_RF_KLIEP.Rdata",sep = ""))
}