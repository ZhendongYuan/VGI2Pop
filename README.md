...
3. OSM data downloaded from OHSOME API (raw data is not contained but the collecting code available); 
4. Twitter data downloaded from Twitter API (raw data is not contained but the collecting code available); 
