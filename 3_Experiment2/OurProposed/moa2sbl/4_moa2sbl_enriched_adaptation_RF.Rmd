...
```{r}
# load loa and moa
target_data = get(load("/data/*********Backup/london/20191213/enriched_feature/sbl_enriched_covariates.Rdata"))
plot(density(target_data$B_NUMBER))
colnames(target_data)
source_data = get(load("/data/*********Backup/london/20191213/enriched_feature/moa_enriched_covariates.Rdata"))
...
weights = get(load("/data/*********Backup/london/20191213/enriched_feature/moa2sbl_weights_uLSIF.Rdata"))
summary(weights)
...
temp = sb_shape@data
save(temp,file="/home/z/*********/london/enriched_feature/moa2sbl/enriched_sbl_predict_pop_ulsif_1.Rdata")
