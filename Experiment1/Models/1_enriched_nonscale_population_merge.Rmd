---
title: "1_enriched_nonscale_population"
...
moa_data_shape <- readOGR("/home/z/zhendong/london/enriched_feature/moa_enriched.shp")
moa_data = moa_data_shape@data
colnames(moa_data)
#merge /home/z/zhendong/london/Rspace/pop/raw_pop_mid_london.Rdata
raw_pop_mid_london = get(load("/home/z/zhendong/london/Rspace/pop/raw_pop_mid_london.Rdata"))
...
summary(moa_data)
save(moa_data,file = "/home/z/zhendong/london/enriched_feature/moa_enriched_covariates_nonscaled.Rdata")
...
```{r}
# at here the scaled_moa_feature.Rdata stands for only scaled populaiton 
loa_data_shape <- readOGR("/home/z/zhendong/london/enriched_feature/loa_enriched.shp")
loa_data = loa_data_shape@data
colnames(loa_data)
summary(loa_data)
#merge /home/z/zhendong/london/Rspace/pop/raw_pop_mid_london.Rdata
raw_pop_loa_london = get(load("/home/z/zhendong/london/Rspace/pop/raw_pop_london_low.Rdata"))
...
#save(moa_data,file = "/home/z/zhendong/london/enriched_feature/moa_enriched_covariates.Rdata")
save(loa_data_reordered,file = "/home/z/zhendong/london/enriched_feature/loa_enriched_covariates_nonscaled.Rdata")
...
```{r}
# at here the scaled_moa_feature.Rdata stands for only scaled populaiton 
sbl_data_shape <- readOGR("/home/z/zhendong/london/enriched_feature/street_blocksl_withinloa.shp")
...
save(sbl_data,file = "/home/z/zhendong/london/enriched_feature/sbl_enriched_covariates_nonscaled.Rdata")
```
