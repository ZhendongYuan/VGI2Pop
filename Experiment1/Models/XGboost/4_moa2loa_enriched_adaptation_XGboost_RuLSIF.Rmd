---
title: "moa2loa_enriched_adaptation_XGboost_RuLSIF"
...
save(source_data,file = "/home/z/zhendong/london/enriched_feature/moa2loa_enriched_weights_XGboost_RuLSIF.Rdata")
...
plot(result_df$target_pop,result_df$loa_transferred_predict,xlim = c(0,1),ylim = c(0,1))
abline(0,1, col='blue')
...
plot(de_nor_result_df$loa_pop,de_nor_result_df$descaled_loa_transferred_predict,xlim = c(0,10000),ylim = c(0,10000))
abline(0,1, col='blue')
summary(de_nor_result_df)
```
