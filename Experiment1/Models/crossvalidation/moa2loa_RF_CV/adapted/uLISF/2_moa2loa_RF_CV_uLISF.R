...
library("Metrics")
library("densratio")
setwd("/home/z/zhendong/london/enriched_feature/moa2loa_RF_CV/uLISF")
...
weights = get(load("/home/z/zhendong/london/enriched_feature/moa2loa_weights_uLSIF.Rdata"))
...
for (i in c(29:50))
{
  ...
  save(singletime,file = paste(i,"_moa2loa_RF_uLSIF.Rdata",sep = ""))
}