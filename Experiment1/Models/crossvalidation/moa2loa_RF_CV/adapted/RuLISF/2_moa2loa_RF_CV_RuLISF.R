...
library("Metrics")
library("densratio")
setwd("/home/z/zhendong/london/enriched_feature/moa2loa_RF_CV/RuLISF")
...
weights = get(load("/home/z/zhendong/london/enriched_feature/moa2loa_weights_RuLSIF.Rdata"))
...
for (i in c(21:50))
{
  ...
  loa_transfer_predict = as.data.frame(h2o.predict(h2o.RuLISF, loa_transferred.h2o))
  ...
  save(singletime,file = paste(i,"_moa2loa_RF_RuLSIF.Rdata",sep = ""))
}
