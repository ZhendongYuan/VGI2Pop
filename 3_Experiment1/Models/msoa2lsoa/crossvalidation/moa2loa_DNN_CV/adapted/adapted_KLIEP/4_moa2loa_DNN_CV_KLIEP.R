...
library("BBmisc")
#2_moa2loa_DNN_CV
setwd("D:/londonPop/enriched_feature/crossValidation/adapted_KLIEP")
...
weights = get(load("D:/londonPop/enriched_feature/moa2loa_weights_KLIEP.Rdata"))
...
for (i in c(1:50))
{
  ...
  save(singletime,file = paste(i,"_moa2loa_DNN_KLIEP.Rdata",sep = ""))
}