...
```{r}
#popdensity_class <- readOGR("/home/z/zhendong/london/multiclassdsymetric/classdensity.shp")
popdensity_class <- readOGR("/data/zhendongBackup/london/multiclassdsymetric/classdensity.shp")
...
# total fraction
moa_class <- readOGR("/data/zhendongBackup/london/multiclassdsymetric/lulc_london_temp.shp")
...
save(result_sbl,file = "/data/zhendongBackup/london/multiclassdsymetric/result_sbl.Rdata")
```
...
```{r}
lulc_london_loa <- readOGR("/home/z/zhendong/london/multiclassdsymetric/lulc_london_loa.shp")
# here
...
colnames(london_low_output@data)
save(london_low_output, file="/home/z/zhendong/london/multiclassdsymetric/london_low_output.Rdata")
```
