...
```{r}
ulb_raw_features = read.csv("/home/z/zhendong/london/ULB_ATLAS/ulb_raw_features.csv")
```
...
moa_pop = get(load("/home/z/zhendong/london/Rspace/pop/raw_pop_mid_london.Rdata"))
colnames(moa_pop)
...
```{r}
sbl_data_features= read.csv("/home/z/zhendong/london/ULB_ATLAS/ulb_raw_features_sbl.csv")
...
writeOGR(sb_shape,dsn ="/home/z/zhendong/london/ULB_ATLAS",layer = "predicted_adj_sbl",driver = "ESRI Shapefile")
```
```{r}
...
writeOGR(london_low,dsn ="/home/z/zhendong/london/ULB_ATLAS",layer = "predicted_adj_sbl_loa",driver = "ESRI Shapefile")
```
