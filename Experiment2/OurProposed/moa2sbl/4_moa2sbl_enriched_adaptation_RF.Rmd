---
title: "enriched_moa2sbl_keepall"
...
```{r}
# load loa and moa
target_data = get(load("/data/zhendongBackup/london/20191213/enriched_feature/sbl_enriched_covariates.Rdata"))
plot(density(target_data$B_NUMBER))
colnames(target_data)
source_data = get(load("/data/zhendongBackup/london/20191213/enriched_feature/moa_enriched_covariates.Rdata"))
...
weights = get(load("/data/zhendongBackup/london/20191213/enriched_feature/moa2sbl_weights_uLSIF.Rdata"))
summary(weights)
...
h2o.varimp_plot(h2o.moa.final,num_of_features = 15)
...
# weighted model adapted applied to data at sbl level
```{r}
target_data = get(load("/home/z/zhendong/london/enriched_feature/sbl_enriched_covariates.Rdata"))
colnames(target_data)
#target_data$population = NULL
...
temp = sb_shape@data
save(temp,file="/home/z/zhendong/london/enriched_feature/moa2sbl/enriched_sbl_predict_pop_ulsif_1.Rdata")
...
```{r}
sb_transferred_predict = get(load("/home/z/zhendong/london/enriched_feature/moa2sbl/predicted_result_temp.Rdata"))
sb_shape <- readOGR("/home/z/zhendong/london/enriched_feature/street_blocksl_withinloa.shp")
...
#writeOGR(sb_shape,dsn ="/home/z/zhendong/london/enriched_feature/moa2sbl",layer = "predicted_adj_sbl",driver = "ESRI Shapefile")
```
```{r}
...
#writeOGR(london_low,dsn ="/home/z/zhendong/london/enriched_feature/moa2sbl",layer = "sbl_predicted_adj_loa",driver = "ESRI Shapefile")
```
