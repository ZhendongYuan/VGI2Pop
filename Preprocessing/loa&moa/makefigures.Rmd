...
#read dataset sbl
```{r}
ULB_sbl_2 <- get(load("/home/z/zhendong/london/ULB_ATLAS/predicted_adj_sbl_2.Rdata"))
...
# the loa 
```{r}
ULB_sbl_2_loa <- readOGR("/home/z/zhendong/london/ULB_ATLAS/predicted_adj_sbl_loa_adapted_2.shp")
...
#read dataset sbl
```{r}
multi_sbl <- get(load("/data/zhendongBackup/london/multiclassdsymetric/result_sbl.Rdata"))
...
# the loa 
```{r}
multi_loa <- get(load("/home/z/zhendong/london/multiclassdsymetric/london_low_output.Rdata"))
...
```{r}
our_sbl <- get(load("/home/z/zhendong/london/enriched_feature/moa2sbl/predicted_adj_sbl.Rdata"))
summary(our_sbl$prd_dj_)
our_sbl_2_loa <- get(load("/home/z/zhendong/london/enriched_feature/moa2sbl/sbl_predicted_adj_loa.Rdata"))
summary(our_sbl_2_loa$prd_l_p)
```
# save as Rdata to release space.
```{r echo=False}
our_sbl <- readOGR("/home/z/zhendong/london/enriched_feature/moa2sbl/predicted_adj_sbl.shp")
our_sbl_2_loa <- readOGR("/home/z/zhendong/london/enriched_feature/moa2sbl/sbl_predicted_adj_loa.shp")
save(our_sbl, file="/home/z/zhendong/london/enriched_feature/moa2sbl/predicted_adj_sbl.Rdata")
save(our_sbl_2_loa, file="/home/z/zhendong/london/enriched_feature/moa2sbl/sbl_predicted_adj_loa.Rdata")
```
